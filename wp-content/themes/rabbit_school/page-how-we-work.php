        ...
        <?php 
            ...
            <div class="flex flex-col lg:flex-row gap-[10px] lg:gap-[20px] items-center justify-center">
                <?php foreach ($section_2_buttons as $btn): ?>
                    <a href="<?php echo esc_url($btn[1]); ?>" class="uppercase flex items-center gap-[5px] bg-brand-yellow hover:bg-brand-orange text-text-main/80 hover:text-text-light text-[10px] sm:text-[12px] md:text-[13px] lg:text-[14px] font-semibold px-[24px] py-[12px] rounded-[8px] shadow-md hover:shadow-xl transition-all group">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            ...
            <div class="lg:col-span-7 flex flex-col items-start">
                ...
                <div class="mb-6 w-full">
                    ...
                    <ul class="list-disc list-outside pl-5 space-y-2 text-text-muted text-[14px] sm:text-[15px] md:text-[16px] font-sans marker:text-brand-orange">
                        <?php 
    ...
    <div class="max-w-7xl mx-auto pb-[64px] md:pb-[50px] px-[20px] 2xl:px-0">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            ...
            <div class="lg:col-span-7 flex flex-col items-start order-1 lg:order-2">
                ...
                <p class="text-text-light text-[14px] sm:text-[15px] md:text-[16px] font-sans leading-relaxed mb-6">
                ...
                <p class="text-text-light font-sans font-medium text-[14px] sm:text-[15px] md:text-[16px] mb-4">
                ...
                <ul class="list-disc list-outside pl-5 space-y-2 text-text-light text-[14px] sm:text-[15px] md:text-[16px] font-sans marker:text-brand-yellow">
                    <?php 
    ...
    <div class="max-w-7xl mx-auto pb-[64px] md:pb-[50px] px-[20px] 2xl:px-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto">
            <?php foreach ($feature_cards as $card): ?>
                <div class="bg-brand-cream rounded-[28px] overflow-hidden flex flex-col shadow-md hover:shadow-xl transition-all">

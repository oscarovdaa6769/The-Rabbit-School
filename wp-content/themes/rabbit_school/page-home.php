...
<div class="relative overflow-hidden">
      ...
      ?>
      <img src="<?php echo $hero_image ? esc_url($hero_image['url']) : get_theme_file_uri('assets/images/banner1.png'); ?>" alt="" class="h-[500px] md:h-[700px] w-full object-cover">
      ...
      <div class="absolute bottom-6 md:bottom-20 left-[20px] right-[20px] md:left-[100px] max-w-2xl text-text-light z-50">
            <h1 class="font-heading text-[32px] sm:text-[36px] md:text-[40px] lg:text-[48px] font-black leading-tight mb-2 md:mb-4 uppercase">
                  <?php the_field('hero_banner_title'); ?>
            </h1>
...
<div class="relative overflow-hidden">
      <?php 
      // Fetch the second image array from ACF
      $story_image = get_field('our_story_image'); 
      ?>
      <img src="<?php echo $story_image ? esc_url($story_image['url']) : get_theme_file_uri('assets/images/banner2.jpg'); ?>" alt="" class="h-[500px] md:h-[700px] w-full object-cover">
      
      <div class="absolute bottom-6 md:bottom-20 left-[20px] right-[20px] md:left-[100px] max-w-2xl text-text-light z-50">
            <h1 class="font-heading text-[32px] sm:text-[36px] md:text-[40px] lg:text-[48px] font-black leading-tight mb-2 md:mb-4">
                  <?php the_field('our_story_title'); ?>
            </h1>
            <p class="text-[12px] sm:text-[13px] md:text-[14px] lg:text-[16px] leading-relaxed opacity-90">
                  <?php the_field('our_story_description'); ?>
            </p>
            <div class="flex justify-start mt-6">
                  <a href="<?php echo esc_url(get_field('our_story_read_more_link')); ?>" class="group bg-brand-brown text-text-light font-bold text-sm px-[24px] py-[12px] rounded-[8px] shadow-lg hover:scale-105 active:scale-95 transition-all inline-flex gap-3 items-center uppercase tracking-wider">
                        read more

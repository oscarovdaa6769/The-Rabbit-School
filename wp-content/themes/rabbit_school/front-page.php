    ...
    <div class="w-full max-w-7xl mx-auto py-[64px] md:py-[50px] px-[20px] 2xl:px-0">
      <div class="max-w-2xl text-text-light">
        ...
        <div class="flex justify-start mt-[16px]">
          <a href="<?php echo esc_url($btn_2_lnk); ?>" class="group bg-brand-yellow hover:bg-brand-orange text-text-main/90 hover:text-text-light font-bold text-sm px-[24px] py-[12px] rounded-[8px] shadow-md hover:shadow-xl transition-all duration-300 inline-flex gap-3 items-center uppercase tracking-widest hover:scale-105 active:scale-95">
            <?php echo esc_html($btn_2_txt); ?>
            <span class="icon-[solar--arrow-right-linear] w-5 h-5 flex-shrink-0 transition-transform duration-300 group-hover:translate-x-1"></span>
          </a>
        </div>
        <?php endif; ?>
      </div>
  ...
  <div class="max-w-7xl mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
      ...
      <div class="flex flex-col">
        <span class="text-brand-brown/80 font-bold tracking-[0.2em] text-[16px] uppercase mb-3">
        ...
        <div class="flex justify-start">
          <a href="<?php echo esc_url($btn_3_lnk); ?>" class="group bg-brand-yellow hover:bg-brand-orange text-text-main/90 hover:text-text-light font-bold text-sm px-[24px] py-[12px] rounded-[8px] shadow-md hover:shadow-xl transition-all duration-300 inline-flex gap-3 items-center uppercase tracking-widest hover:scale-105 active:scale-95">
...
<section class="bg-brand-yellow relative overflow-hidden">
  ...
  <div class="max-w-7xl mx-auto py-[64px] md:py-[50px] px-[20px] 2xl:px-0 text-center relative z-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[20px] 2xl:gap-[30px]">
      <?php foreach ($impacts as $item): ?>
      <div class="group bg-white/95 backdrop-blur-sm rounded-[24px] shadow-xl p-[24px] md:p-[32px] flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-3 hover:shadow-2xl border-b-8 border-transparent hover:border-brand-brown">
        <div class="mb-6 h-20 w-20 bg-brand-yellow/20 rounded-full flex items-center justify-center flex-shrink-0 transition-transform duration-500">
          <img src="<?php echo esc_url($item[0]); ?>" alt="" class="h-12 w-auto object-contain flex-shrink-0 transition-transform duration-500 group-hover:rotate-45">
        </div>
  ...
  <div class="max-w-7xl mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
      ...
      <div class="flex flex-col">
        ...
        <?php if ( !empty($btn_6_txt) ) : ?>
        <div class="flex justify-start">
          <a href="<?php echo esc_url($btn_6_lnk); ?>" class="group bg-brand-yellow hover:bg-brand-orange text-text-main/90 hover:text-text-light font-bold text-sm px-[24px] py-[12px] rounded-[8px] shadow-md hover:shadow-xl transition-all duration-300 inline-flex gap-3 items-center uppercase tracking-widest hover:scale-105 active:scale-95">

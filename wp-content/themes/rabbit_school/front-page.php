...
// section 1
$img_1_url = get_field('image_1_url') ?: get_theme_file_uri('assets/images/error.png');
$title_1 = get_field('title_1') ?: 'SECTION 1 NOT WORKING';
$desc_1 = get_field('desc_1') ?: 'DESC 1 NOT WORKING';

// section 2
$image_2_url = get_field('image_2_url') ?: get_theme_file_uri('assets/images/error.png');
$title_2 = get_field('title_2') ?: 'SECTION 2 NOT WORKING';
$desc_2 = get_field('desc_2') ?: 'DESC 2 NOT WORKING';
$btn_2_txt = get_field('btn_2_txt') ?: 'BTN 2 NOT WORKING';
$btn_2_link = get_field('btn_2_link') ?: '#';

// section 3
$img_3_url = get_field('img_3_url') ?: get_theme_file_uri('assets/images/error.png');
$sub_title_3 = get_field('sub_heading_3') ?: 'SUB SECTION 3 NOT WORKING';
$title_3 = get_field('title_3') ?: 'SECTION 3 NOT WORKING';
$desc_3 = get_field('desc_3') ?: 'DESC 3 NOT WORKING';
$btn_3_txt = get_field('btn_3_txt') ?: 'BTN 3 NOT WORKING';
$btn_3_lnk = get_field('btn_3_lnk') ?: '#';

// section 4 
$title_4 = get_field('title_4') ?: 'SECTION 4 NOT WORKING';
$desc_4 = get_field('desc_4') ?: 'DESC 4 NOT WORKING';

$img_card1_url = get_field('img_card1_url') ?: get_theme_file_uri('assets/images/error.png');
$card_1_title = get_field('card_1_title') ?: 'DESC CARD1 NOT WORKING';
$card_1_desc = get_field('card_1_desc') ?: 'TITLE CARD NOT WORKING';

$img_card2_url = get_field('img_card2_url') ?: get_theme_file_uri('assets/images/error.png');
$card_2_title = get_field('card_2_title') ?: 'TITLE CARD NOT WORKING';
$card_2_desc = get_field('card_2_desc') ?: 'DESC CARD2 NOT WORKING';

$img_card3_url = get_field('image_card3') ?: get_theme_file_uri('assets/images/error.png');
$card_3_title = get_field('card_3_title') ?: 'TITLE CARD NOT WORKING';
$card_3_desc = get_field('card_3_desc') ?: 'DESC CARD3 NOT WORKING';

$img_card4_url = get_field('image_card4') ?: get_theme_file_uri('assets/images/error.png');
$card_4_title = get_field('card_4_title') ?: 'TITLE CARD NOT WORKING';
$card_4_desc = get_field('card_4_desc') ?: 'DESC CARD4 NOT WORKING';

$impacts = [
    [$img_card1_url, $card_1_title, $card_1_desc],
    [$img_card2_url, $card_2_title, $card_2_desc],
    [$img_card3_url, $card_3_title, $card_3_desc],
    [$img_card4_url, $card_4_title, $card_4_desc]
];
...
// section 6
$image_6_url = get_field('image_6_url') ?: get_theme_file_uri('assets/images/error.png');
$sub_title_6 = get_field('sub_title_6') ?: 'SUB SECTION 6 NOT WORKING';
$title_6 = get_field('title_6') ?: 'SECTION 6 NOT WORKING';
$desc_6 = get_field('desc_6') ?: 'DESC 6 NOT WORKING';
$btn_6_txt = get_field('btn_6_txt') ?: 'BTN 6 NOT WORKING';
$btn_6_link = get_field('btn_6_link') ?: '#';
?>
...
<!-- section 2 -->
<div class="relative overflow-hidden">
      <img src="<?php echo esc_url($image_2_url); ?>" alt="<?php echo esc_attr($title_2); ?>" class="h-[500px] md:h-[700px] w-full object-cover">
            ...
            <div class="w-full max-w-7xl mx-auto">
                  <div class="max-w-2xl text-text-light">
                        ...
                        <div class="flex justify-start mt-6">
                              <a href="<?php echo esc_url($btn_2_link); ?>" class="group bg-brand-brown text-text-light font-bold text-sm px-[24px] py-[12px] rounded-[8px] shadow-lg hover:scale-105 active:scale-95 transition-all inline-flex gap-3 items-center uppercase tracking-widest">
      ...
      <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
                  ...
                  <div class="relative">
                        <div class="absolute -top-4 -right-4 w-full h-full border-2 border-brand-yellow rounded-2xl -z-10 hidden md:block"></div>
                        <div class="w-full aspect-[4/3] md:aspect-video rounded-[24px] overflow-hidden shadow-2xl transition-transform duration-500 hover:scale-[1.02]">
                              <img src="<?php echo esc_url($image_6_url); ?>" alt="<?php echo esc_attr($title_6); ?>" class="h-full w-full object-cover">
                        </div>
                  </div>
                  ...
                  <div class="flex flex-col">
                        ...
                        <div class="flex justify-start">
                              <a href="<?php echo esc_url($btn_6_link); ?>" class="group bg-brand-brown text-text-light font-bold text-sm px-[24px] py-[12px] rounded-[8px] shadow-md hover:bg-brand-brown/90 hover:shadow-xl transition-all inline-flex gap-3 items-center uppercase tracking-widest">

...
// Follow the active Polylang language for the small UI strings below
// (adjust the Khmer slug here if your Polylang setup uses a different one,
// e.g. 'kh' instead of 'km').
$current_lang = function_exists('pll_current_language') ? pll_current_language('slug') : 'en';
$is_khmer     = in_array($current_lang, array('km', 'kh', 'khmer'), true);

$apply_now_text  = $is_khmer ? 'ដាក់ពាក្យសុំឥឡូវនេះ' : 'Apply Now';
$show_less_text  = $is_khmer ? 'បង្ហាញតិចជាង' : 'Show Less';
